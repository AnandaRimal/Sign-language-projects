      ...
      <section className="gesture-speak__section gesture-speak__models">
        ...
        <div className="model-comparison">
          ...
          <div className="model-card">
            ...
            <ul>
              <li>About 64.7% validation accuracy</li>
              <li>Faster processing speed</li>
              <li>Basic gesture support</li>
              <li>Use our desktop GUI to use scratch cnn model with 99.26 validation accuracy</li>
              <li>Unable to implement that model due its size around 1.6GB</li>
            </ul>
          </div>
        </div>
      </section>
